...
class LZA_CodeMirror_Debug {
    ...
    public static function init() {
        add_action('admin_init', array(__CLASS__, 'check_debug_flag'));
    }
    ...
    public static function check_debug_flag() {
        if (isset($_GET['debug_lza']) && $_GET['debug_lza'] == '1' && current_user_can('manage_options')) {
            add_action('admin_notices', array(__CLASS__, 'show_debug_info'));
            add_action('admin_footer', array(__CLASS__, 'add_debug_script'));
        }
    }
